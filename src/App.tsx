...
const projects = [
  {
    ...
    subtitle: "Immersive Automotive Experience",
    description: "A dark, cinematic web experience for the Porsche 911 GT3 RS. Custom cursor, parallax hero, animated spec cards, horizontal scroll gallery — inspired by the world's finest automotive design studios.",
    tags: ["Immersive Design", "Parallax", "Automotive"],
    icon: <Cpu className="w-7 h-7 text-red-500" />,
    link: "/porsche/index.html",
    image: "/porsche/images/hero.png",
    accent: "red",
    year: "2025",
  },
  {
    title: "Nike Air Force 1",
    subtitle: "Interactive Shoe Showcase",
    description: "An Awwwards-level interactive showcase for the iconic Nike Air Force 1 collection. Switch between colorways with arrows and watch the entire site — colors, particles, shadows — morph in real-time.",
    tags: ["Dynamic Themes", "Interactive UI", "Micro-Animations"],
    icon: <Sparkles className="w-7 h-7 text-orange-400" />,
    link: "/nike-airforce/index.html",
    image: "/nike-airforce/images/af1-white.png",
    accent: "orange",
    year: "2025",
  },
];
